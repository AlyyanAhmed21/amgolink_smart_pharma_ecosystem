...
class Doctor {
  ...
  // Added fields for compatibility with Boss/Manager screens
  final String address;
  final String phone;
  final String revenue;
  final String growth;
  final String time;
  // New fields for Sales Rep screen
  final int visits;
...
class MockData {
  ...
  // Patient Data (Kept for compatibility)
  ...
  // Manager Data (Kept for compatibility)
...
// ALIASES (These ensure your old screens don't break)
